    ...
    public class DragRigidbody : MonoBehaviour
    {
        ...
        void TryDragObject()
        {
            ...
            if (fixedHold)
            {
                ...
                fixedVelocityRigid.angularDamping = heldRigidbody.angularDamping;
                fixedVelocityRigid.linearDamping = heldRigidbody.linearDamping;
        ...
        void HoldObject()
        {
            ...
            heldRigidbody.linearVelocity = (grabPos - currPos) * DragSmoothing;
            ...
            if (fixedHold && fixedVelocityObj && fixedVelocityRigid)
            {
                ...
                fixedVelocityRigid.linearVelocity = fixedVelocity;
            }
        ...
        public void ResetDrag(bool throwObj)
        {
            ...
            if (objectHeld && heldRigidbody)
            {
                ...
                {
                    heldRigidbody.AddForce(fixedVelocityRigid.linearVelocity, ForceMode.VelocityChange);
                }
