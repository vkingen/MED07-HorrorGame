...
namespace HFPS.Systems
{
    ...
    public class DraggableObject : MonoBehaviour, ISaveable
    {
        ...
        void Awake()
        {
            ...
            initialDrag = m_rigidbody.linearDamping;
            initialAngularDrag = m_rigidbody.angularDamping;
        ...
        void FixedUpdate()
        {
            if (water != null && voxels.Length > 0)
            {
                ...
                m_rigidbody.linearDamping = Mathf.Lerp(initialDrag, dragInWater, submergedVolume);
                m_rigidbody.angularDamping = Mathf.Lerp(initialAngularDrag, angularDragInWater, submergedVolume);
            }
        }
